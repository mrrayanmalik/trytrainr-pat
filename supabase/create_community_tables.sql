-- First, fix the courses table policies to prevent recursion
...
-- Now create the missing community management tables
...
AND table_name IN ('communities', 'community_messages', 'community_members');

-- Check policies on courses (should show the new simple policies)
