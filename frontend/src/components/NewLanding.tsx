...
// import Pricing from './Pricing'; // Commented out to avoid dependencies
...
export default function NewLanding({ onLogin, onShowEducatorSignup }: NewLandingProps) {
  ...
  const handleGetStarted = () => {
    if (onShowEducatorSignup) {
      ...
      console.log('Get started clicked - will implement later');
    }
  };
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 via-blue-50 to-green-50 min-h-screen">
      ...
      {/* Simple Pricing Section (since we commented out the Pricing component) */}
      <div id="pricing-section" className="bg-gray-50 py-20 scroll-mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Replace $1000+ of tools with one simple subscription
            </p>
          </div>
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl p-8 text-white text-center">
              ...
              <div className="text-purple-100 mb-8">per month</div>
