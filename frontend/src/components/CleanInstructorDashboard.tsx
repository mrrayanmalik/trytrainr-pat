...
const CleanInstructorDashboard: React.FC = () => {
  ...
  // Mock data (removing all backend calls)
  const analytics = {
    totalRevenue: 45280,
    totalStudents: 1247,
    totalCourses: 12,
  ...
  const topCourses = [
    {
      ...
      course_analytics: { total_students: 284, avg_rating: 4.8, revenue: 2840 }
    },
    {
      id: 2,
      title: "React Development Bootcamp", 
      course_analytics: { total_students: 156, avg_rating: 4.9, revenue: 1560 }
    },
    {
      id: 3,
      title: "Node.js Backend Development",
      course_analytics: { total_students: 98, avg_rating: 4.7, revenue: 980 }
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
              ...
              <p className="text-gray-600">
                This view is under construction. The UI components for {currentView} will be implemented here.
              </p>
            </div>
          </div>
        )}
